...
public class View extends AbstractComponent {
    ...
    public <T extends AbstractComponent>
    GameObject addLabel(String name, String text, String color, double posX, double posY, int left, int top, int fontSize, boolean bold, Class<T>... components) {
        GameObject label = new GameObject(name);
        LabelGraphic lGraphic = label.addComponent(LabelGraphic.class);
        lGraphic.setLabelText(text);
        lGraphic.setWebColor(color);
        lGraphic.setLeft(left);
        lGraphic.setTop(top);
        lGraphic.setFontSize(fontSize);
        lGraphic.setBold(bold);
    ...
    GameObject addCup(String goName,
                      String name, String path, String name2, String path2, String name3, String path3,
                      double posX, double posY, int width, int height, int left, int top,
                      Class<T>... components) {
        ...
        dcImage.setClosedCup(name2, path2, posX, posY, width, height, left, top);
        dcImage.setPeekCup(name3, path3, posX, posY, width, height, left, top);
